    ...
    <div className="relative min-h-screen bg-[#030303] text-white pt-24">
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4">خدمات تخصصی استیرا</h1>
          <p className="text-xl text-white/40">راهکارهای هوشمندانه برای آشپزخانه‌های مدرن</p>
        </div>
          ...
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-6">{pkg.title}</h2>
                ...
                <div className="bg-white/[0.03] p-8 rounded-2xl border border-white/5">
                  <h3 className="text-sm font-semibold uppercase tracking-wider text-rose-500 mb-6">ویژگی‌های کلیدی</h3>
