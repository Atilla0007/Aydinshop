                    ...
                    <div>
                      ...
                      <p className="text-lg text-white/60 mb-8 leading-[2.6] font-iran">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                          <Button size="lg" className="rounded-full font-iran bg-rose-600 hover:bg-rose-700" asChild>
                            <Link to={`/services/${pkg.id}`}>مشاهده جزئیات پکیج</Link>
                          </Button>
                          <Button size="lg" variant="outline" className="rounded-full font-iran border-white/10 hover:bg-white/5" asChild>
                            <Link to={`/contact?package=${pkg.id}`}>درخواست مشاوره</Link>
                          </Button>
                        </div>
